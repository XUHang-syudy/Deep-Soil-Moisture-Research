...
for k in range(1, 45):
    ...
    for j in range(df.shape[0]):
        if df.iloc[j, 1] > 3.0:
            ...
            # Feature calculation and integration (Target: DSWD_mm)
...
selected_features = ['depth_m', 'RDWD_kg_m3', 'FRLD_m_m3', 'species_code', 
...
# Axis and frame settings (labels unchanged)
