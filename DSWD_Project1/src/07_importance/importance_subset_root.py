...
# Select full-variable feature subset (environmental + root traits)
selected_cols = ['depth_m', 'RDWD_kg_m3', 'FRLD_m_m3', 'species_code', 
...
# Export results
results.to_excel(RESULTS_DIR / "feature_importance" / "RF_importance_subset_full.xlsx", index=False)
print("✅ Full-variable mechanism analysis complete. Results exported with new scientific naming.")